...
public class GenericsFehler {
	...
	public static void main(String[] args) {
		...
		mg.set(s1);
		// mg.set(i1); // es wurden ein String initialisiert aber i1 ist ein integer
		String s3 = mg.get();
		// Integer i3 = (Integer) mg.get(); // um aus einem String einen Integer zu
		// machen muss man parsen
	}
}
